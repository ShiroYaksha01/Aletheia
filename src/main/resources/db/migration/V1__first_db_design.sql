...
CREATE TABLE IF NOT EXISTS papers (
    ...
    CONSTRAINT fk_paper_author FOREIGN KEY (user_id) REFERENCES users (user_id)
);
...
CREATE TABLE IF NOT EXISTS co_authors (
    ...
    CONSTRAINT fk_coauthor_paper FOREIGN KEY (paper_id) REFERENCES papers (id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS assignments (
    ...
    CONSTRAINT fk_assignment_paper FOREIGN KEY (paper_id) REFERENCES papers(id) ON DELETE CASCADE,
